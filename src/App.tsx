      ...
      <div className={`w-full rounded-[28px] flex flex-col p-5 ${glassPanel} mt-2`}>
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('perfil'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('dados'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <Shield size={22} />
                </div>
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('personalizacao'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <Palette size={22} />
                </div>
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('memorias'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <Brain size={22} />
                </div>
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('voz'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <Mic size={22} />
                </div>
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('controle_pais'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <Baby size={22} />
                </div>
          ...
          <div className="relative">
            ...
            <div onClick={() => { setUnavailablePopup('assinar'); setTimeout(() => setUnavailablePopup(null), 2500); }} className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <CreditCard size={22} />
                </div>
          ...
          <div className="relative flex flex-col">
            <div onClick={() => handleTogglePopup('sensitive')} className="flex items-center justify-between py-2.5 cursor-pointer transition-opacity hover:opacity-80">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white/80' : 'text-gray-600'}`}>
            ...
            <AnimatePresence>
              {showSensitiveData && (
                ...
                >
                  <button onClick={clearAllHistory} className={`w-full py-2.5 rounded-xl font-medium text-[14px] mt-2 mb-2 shrink-0 transition-all duration-200 flex justify-center items-center gap-2 ${
                    isDarkMode 
        ...
        <div className={`h-[1px] w-full mb-4 mt-2 ${isDarkMode ? 'bg-white/10' : 'bg-gray-200'}`}></div>
        ...
        <div className="mb-2">
          <div className="relative">
            ...
            <div 
              ...
              className="flex items-center justify-between py-2.5 cursor-not-allowed opacity-40 transition-opacity"
            >
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 flex items-center justify-center shrink-0 ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                  <Bell size={22} />
